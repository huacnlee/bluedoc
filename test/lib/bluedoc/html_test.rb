...
class BlueDoc::HTMLTest < ActiveSupport::TestCase
  test "render markdown" do
    ...
    Rails.cache.delete(cache_key)
    assert_html_equal BlueDoc::HTML.render_without_cache(raw, format: :sml), BlueDoc::HTML.render(raw, format: :sml)
  end
  ...
  test "render sml" do
    ...
    out = BlueDoc::HTML.render_without_cache(sml, format: :sml)

    assert_html_equal html, out
    assert_html_equal out, BlueDoc::HTML.render_without_cache(sml, format: :sml)
  ...
  test "markdown heading" do
    assert_html_equal %(<h1 id="this-is-title"><a href="#this-is-title" class="heading-anchor">#</a>This is <strong>title</strong></h1>), BlueDoc::HTML.render("# This is **title**", format: :markdown)
    assert_html_equal %(<h1 id="this-is-title"><a href="#this-is-title" class="heading-anchor">#</a>This is 中文 title</h1>), BlueDoc::HTML.render("# This is 中文 title", format: :markdown)
    assert_html_equal %(<h1 id="this-is"><a href="#this-is" class="heading-anchor">#</a>This_? is</h1>), BlueDoc::HTML.render("# This_? is", format: :markdown)
    assert_html_equal %(<h1 id="a69b2addd"><a href="#a69b2addd" class="heading-anchor">#</a>全中文标题</h1>), BlueDoc::HTML.render("# 全中文标题", format: :markdown)
    assert_html_equal %(<h1 id="583a03ad8"><a href="#583a03ad8" class="heading-anchor">#</a>确保 id 生成是固定的编号</h1>), BlueDoc::HTML.render("# 确保 id 生成是固定的编号", format: :markdown)
  end
  ...
  test "markdown image" do
    out = BlueDoc::HTML.render("![Hello](/uploads/aa.jpg)", format: :markdown)
    ...
    assert_equal html, BlueDoc::HTML.render(html, format: :markdown)
  end
  ...
  test "markdown plantuml" do
    ...
    out = BlueDoc::HTML.render(raw, format: :markdown)
    svg_code = BlueDoc::Plantuml.encode(code.strip)
  ...
  test "markdown with bad link" do
    assert_equal %(<p><a href=""></a></p>), BlueDoc::HTML.render("[]()", format: :markdown)
  end
  ...
  test ".mention_fragments" do
    ...
    fragments = BlueDoc::HTML.mention_fragments(html, "foo")
    ...
    fragments = BlueDoc::HTML.mention_fragments(html, "bar")
    assert_equal 2, fragments.length
    assert_equal "Hello @bar this is heading4", fragments[0]

    fragments = BlueDoc::HTML.mention_fragments(nil, "bar")
